...
/**
 * FEEDBACK_FORM.PHP
 * Versie: Gecentreerde layout & Dynamische velden (Algemeen vs KPI)
 * Notities zijbalk is verwijderd voor een rustiger beeld.
 */
...
if (!$is_new) {
    try {
        ...
        // C. Haal eerdere gesprekken op voor referentie (Alleen als driver bekend is)
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        if ($is_new) {
            ...
            // UPDATE
            array_splice($params, 1, 1); // Verwijder created_by
            $params[] = $form_id;
