...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && !empty($_POST['note_content'])) {
    try {
        // Haal driver_id op uit het verborgen veld
        ...
        // Refresh pagina om dubbele posts te voorkomen
...
try {
    ...
    // B. Notities / Afspraken ophalen (Gekoppeld aan de chauffeur)
...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .main-content { flex-grow: 1; overflow-y: auto; padding: 24px; display: flex; gap: 24px; }
        ...
        .btn-edit { text-decoration: none; border: 1px solid var(--border-color); background: white; color: var(--brand-color); padding: 8px 16px; border-radius: 4px; font-weight: 600; font-size: 13px; display: inline-flex; align-items: center; gap: 5px; }
    </style>
</head>
<body>
